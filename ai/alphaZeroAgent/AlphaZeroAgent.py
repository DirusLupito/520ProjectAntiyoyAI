...
# Add paths for alpha-zero imports
current_dir = os.path.dirname(os.path.abspath(__file__))
alpha_zero_dir = os.path.join(current_dir, '..', '..', 'alpha-zero')
azg_dir = os.path.join(current_dir, '..', '..', 'azg')
sys.path.insert(0, alpha_zero_dir)
sys.path.insert(0, azg_dir)
...
class AlphaZeroAgent:
    ...
    def __init__(
        self,
        checkpoint_folder='alpha-zero/temp',
        checkpoint_file='checkpoint_7.pth.tar.examples',
        use_mcts=True,
        num_mcts_sims=50,
...
def _get_or_create_agent():
    ...
    try:
        ...
        print(f"    cd alpha-zero && python3 main.py")
