class HexTile:
    ...
    A tile has an owner, or province which controls the tile.
    ...
    def __init__(self, neighbors=None, owner=None, unit=None, isWater=False):
        ...
        self.owner = owner  # Province that contains the tile
    ...
    def __str__(self):
        owner_name = self.owner.faction.name if self.owner else "None"
