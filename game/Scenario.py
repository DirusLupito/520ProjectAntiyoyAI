...
class Scenario:
    ...
    def generateRandomScenario(self, dimension, targetNumberOfLandTiles, factions, initialProvinceSize, randomSeed=None):
        """
        ...
        self._setupHexNeighbors(mapData)

        # Generate a contiguous island
        landTiles = self._generateContiguousIsland(mapData, targetNumberOfLandTiles)

        # Distribute land tiles among factions
        self._distributeTilesToFactions(landTiles, factions, initialProvinceSize)
    ...
    def _setupHexNeighbors(self, mapData):
        """
    ...
    def _generateContiguousIsland(self, mapData, targetNumberOfLandTiles):
        """
    ...
    def _distributeTilesToFactions(self, landTiles, factions, initialProvinceSize):
        """
        ...
        startingTiles = self._pickSpacedStartingTiles(landTiles, len(factions))
    ...
    def _pickSpacedStartingTiles(self, landTiles, numFactions):
        """
