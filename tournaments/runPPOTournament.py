...
def runPPOTournament() -> None:
    """
    Script for generating the test data for the PPO related tournament
    Will match up every AI against PPO such that
    each AI will play 50 rounds in slot 1 vs PPO in slot 2,
    then switch and play 50 rounds in slot 2 vs PPO in slot 1.
    ...
    matchups = [
        ("Mark1SRB", "mark1srb", "PPO", "ppo"),
        ("PPO", "ppo", "Mark1SRB", "mark1srb"),
        ("Mark2SRB", "mark2srb", "PPO", "ppo"),
        ("PPO", "ppo", "Mark2SRB", "mark2srb"),
        ("Mark3SRB", "mark3srb", "PPO", "ppo"),
        ("PPO", "ppo", "Mark3SRB", "mark3srb"),
        ("Mark4SRB", "mark4srb", "PPO", "ppo"),
        ("PPO", "ppo", "Mark4SRB", "mark4srb")
    ]
