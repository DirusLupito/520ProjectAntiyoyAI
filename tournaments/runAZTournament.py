...
def runAlphaZeroTournament() -> None:
    """
    ...
    matchups = [
        ("Mark1SRB", "mark1srb", "alphazero", "alphazero"),
        ("alphazero", "alphazero", "Mark1SRB", "mark1srb"),
        ("Mark2SRB", "mark2srb", "alphazero", "alphazero"),
        ("alphazero", "alphazero", "Mark2SRB", "mark2srb"),
        ("Mark3SRB", "mark3srb", "alphazero", "alphazero"),
        ("alphazero", "alphazero", "Mark3SRB", "mark3srb"),
        ("Mark4SRB", "mark4srb", "alphazero", "alphazero"),
        ("alphazero", "alphazero", "Mark4SRB", "mark4srb"),
        ("alphazero", "alphazero", "PPO", "ppo"),
        ("PPO", "ppo", "alphazero", "alphazero"),
        ("AlphaZero", "alphazero", "Minimax", "minimax"),
        ("Minimax", "minimax", "AlphaZero", "alphazero"),
    ]
